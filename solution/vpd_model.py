...
def load_settings():
    """config/settings.json 에서 시뮬레이션 설정값을 읽어옵니다."""
...
# ============================================================
# 1. 지점(관측소) 관련 (지금은 settings.json에서 station_id만 사용)
# ============================================================
...
# ============================================================
# 5. 시설 유형 / 피복 메뉴 (테이블만 사용, 선택은 settings.json 기반)
# ============================================================
FACILITY_TYPES = {
    "1": {
...
###############################################################################
# Main execution flow (settings.json 사용)
###############################################################################
def main():
